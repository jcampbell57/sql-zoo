...
SELECT teamname, COUNT(goal.player) AS 'goals scored'
...
SELECT stadium, COUNT(goal.player) AS 'goals scored'
...
SELECT matchid, mdate, COUNT(goal.player) AS 'goals scored'
  FROM game JOIN goal ON matchid = id 
